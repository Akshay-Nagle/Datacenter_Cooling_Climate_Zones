...
**Key findings:** the Hybrid system cuts on-site water use by 20-60% relative to WCC in every climate, but its energy performance is climate-dependent - saving energy in hot cities, roughly unchanged in one dry, cool climate, and costing 2-5% more in mild or cold climates. A waste-heat-driven AWH model, coupled only to the Hybrid system's condenser loop, recovers the most water where the Hybrid saves the least cooling water, offsetting up to 37% of cooling-water demand in humid climates for an added electricity cost near 8%, and almost nothing in dry ones.
